        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white rounded-3xl border border-gray-200/80 shadow-card overflow-hidden">
            <div className="grid lg:grid-cols-2">
              ...
              {/* Left — Visual side */}
              <div className="relative bg-[#2D1B4E] p-8 lg:p-10 flex flex-col">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  <div className="bg-white/10 rounded-xl px-3 py-3 text-center">
                    ...
                    <div className="text-[0.65rem] text-white/50 uppercase tracking-wider font-semibold mb-0.5">Per m²</div>
                    <div className="text-body-sm font-bold text-white font-heading tabular-nums">
                      {formatPrice(prijsPerM2Laag)}
                    </div>
                  </div>
                  <div className="bg-white/10 rounded-xl px-3 py-3 text-center">
                    <Ruler className="w-4 h-4 text-[#FAD4AE] mx-auto mb-1.5" />
                    <div className="text-[0.65rem] text-white/50 uppercase tracking-wider font-semibold mb-0.5">Gekozen</div>
                    <div className="text-body-sm font-bold text-white font-heading tabular-nums">
                      {m2} m²
                    </div>
                  </div>
                  <div className="bg-white/10 rounded-xl px-3 py-3 text-center">
                    ...
                    <div className="text-[0.65rem] text-white/50 uppercase tracking-wider font-semibold mb-0.5">Range</div>
                    <div className="text-body-sm font-bold text-white font-heading tabular-nums">
                      {wt?.minM2}–{wt?.maxM2} m²
                    </div>
                  </div>
                ...
                {/* Disclaimer */}
                <p className="text-[0.7rem] text-white/40 leading-relaxed mt-auto">
              ...
              <div className="p-8 lg:p-10 flex flex-col">
                    ...
                    {woningtypen.map((w) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg text-caption font-semibold transition-all duration-200 ${
                            isActive
                ...
                <div className="text-center mb-8">
                  <p className="text-caption text-gray-400 uppercase tracking-wider font-semibold mb-3">
                    Geschatte kosten incl. BTW
                  </p>
                  <div className="h-1 rounded-full bg-primary/20 max-w-[120px] mx-auto mb-4">
                    <div className="h-full rounded-full bg-primary w-full" />
                  </div>
                  <div className="text-heading-1 font-extrabold text-dark font-heading tabular-nums tracking-tight">
