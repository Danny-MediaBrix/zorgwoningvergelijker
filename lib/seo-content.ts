...
export const seoContent: Record<string, SeoContent> = {
  ...
  mantelzorgwoning: {
    ...
    financieringTekst:
      "Er zijn meerdere manieren om een mantelzorgwoning te financieren. De meest gebruikte opties zijn de <a href=\"/kennisbank/subsidie-mantelzorgwoning\" class=\"text-primary font-medium hover:underline\">Wmo-bijdrage van je gemeente</a>, de Blijverslening (een lening met lage rente via het Stimuleringsfonds Volkshuisvesting), en het verhogen van de hypotheek op de hoofdwoning. Sommige gemeenten vergoeden tot 100% van de kosten via de Wmo als de zorgbehoefte aantoonbaar is.\n\nDaarnaast kun je denken aan spaargeld, een persoonlijke lening, of de overwaarde op de woning van de zorgontvanger. Huurkoop via de aanbieder is bij sommige leveranciers ook mogelijk. Lees alles over de financieringsmogelijkheden in ons artikel <a href=\"/kennisbank/mantelzorgwoning-financieren\" class=\"text-primary font-medium hover:underline\">mantelzorgwoning financieren</a>. Belangrijk: vergelijk altijd de kosten van een mantelzorgwoning met de maandelijkse kosten van professionele thuiszorg of een verzorgingshuis, een mantelzorgwoning verdient zichzelf vaak binnen 2 tot 3 jaar terug.",
  },

  kangoeroewoning: {
    uitgebreideBeschrijving:
      "Een kangoeroewoning is een woning met twee zelfstandige wooneenheden onder \u00e9\u00e9n dak of direct aan elkaar gebouwd. De naam verwijst naar de kangoeroemodel: de ene generatie 'draagt' de andere, net als een kangoeroe haar jong. Typisch woont de oudere generatie in een gelijkvloerse eenheid op de begane grond, terwijl het gezin van de kinderen de rest van de woning bewoont.\n\nHet grote voordeel van een kangoeroewoning is dat beide huishoudens volledig zelfstandig zijn, met eigen voordeur, keuken en badkamer, maar tegelijk dichtbij wonen voor onderlinge hulp en gezelschap. Dit model wint snel aan populariteit nu de vergrijzing toeneemt en er een tekort is aan seniorenwoningen. In mantelzorgsituaties is de kangoeroewoning een goed alternatief voor een <a href=\"/mantelzorgwoning\" class=\"text-primary font-medium hover:underline\">losstaande mantelzorgwoning</a>. Gemeenten stimuleren meergeneratiewonen steeds vaker via aangepaste bestemmingsplannen.",
    vergunningenTekst:
      "Voor een kangoeroewoning is vrijwel altijd een omgevingsvergunning nodig, omdat je feitelijk twee wooneenheden cre\u00ebert. Het bestemmingsplan moet meergeneratiewonen of woningsplitsing toestaan. Steeds meer gemeenten staan hier welwillend tegenover, maar het is verstandig om vooraf het bestemmingsplan te raadplegen of een vooroverleg aan te vragen bij de gemeente.\n\nBij het gebruik van een prefab unit als tweede eenheid in de tuin kan de mantelzorgvrijstelling van toepassing zijn, mits er een aantoonbare zorgrelatie is. In dat geval is de tweede eenheid <a href=\"/kennisbank/mantelzorgwoning-vergunningsvrij\" class=\"text-primary font-medium hover:underline\">vergunningsvrij tot 100 m\u00B2</a>. Zonder zorgrelatie is altijd een vergunning nodig. Het fiscale aspect is ook relevant: twee afzonderlijke adressen kunnen gevolgen hebben voor toeslagen en belastingen.",
    seniorenTekst:
  ...
  vakantiebungalow: {
    ...
    seniorenTekst:
      "De vakantiebungalow is van nature een ideale seniorenwoning: alles op \u00e9\u00e9n verdieping, een overzichtelijke indeling en vaak gesitueerd in een rustige, groene omgeving. Op vakantieparken met permanente bewoning vind je bovendien gelijkgestemde buren en georganiseerde activiteiten. Het sociale aspect mag niet worden onderschat, eenzaamheid is een van de grootste uitdagingen voor senioren, en het parkleven biedt een natuurlijk sociaal vangnet. Wie liever een ruimere houten woning wil op een park, kan ook een <a href=\"/lodge\" class=\"text-primary font-medium hover:underline\">lodge</a> vergelijken.",
    seniorenChecklist: [
  ...
  "prefab-woning": {
    ...
    financieringTekst:
      "Een prefab woning op eigen grond kan gefinancierd worden met een reguliere hypotheek of bouwhypotheek, net als traditionele nieuwbouw. Het voordeel is dat de bouwperiode korter is, waardoor de dubbele lasten (oude woning + nieuwbouw) beperkt blijven.\n\nVoor 50-plussers die hun huidige woning verkopen en een nieuwe prefab woning laten bouwen, zijn er aantrekkelijke mogelijkheden. De overwaarde kan als eigen inbreng dienen, waardoor de maandlasten laag blijven. Bij nieuwbouw betaal je geen overdrachtsbelasting (alleen BTW) en kun je profiteren van de <a href=\"/kennisbank/subsidie-mantelzorgwoning\" class=\"text-primary font-medium hover:underline\">ISDE-subsidie</a> bij duurzame installaties. De Nationale Hypotheek Garantie (NHG) is mogelijk tot de NHG-grens.",
  },

  systeemwoning: {
    uitgebreideBeschrijving:
      "Een systeemwoning is een industrieel geproduceerde woning die bestaat uit gestandaardiseerde bouwsystemen. Anders dan bij <a href=\"/prefab-woning\" class=\"text-primary font-medium hover:underline\">prefab woningen</a>, waar individuele panelen op locatie worden geassembleerd, wordt bij systeembouw gewerkt met complete bouwsystemen die als geheel zijn ontworpen en goedgekeurd. Dit maakt systeemwoningen bijzonder geschikt voor projectmatige bouw: hele wijken kunnen in korte tijd worden gerealiseerd.\n\nHet voordeel van systeembouw voor de individuele koper is de typegoedkeuring. Doordat het volledige systeem vooraf is getest en goedgekeurd, verloopt het vergunningsproces sneller en is er meer zekerheid over de kwaliteit en prestaties van de woning. Systeemwoningen zijn er van compact (70 m\u00B2) tot ruim (200 m\u00B2) en worden permanent op een fundering gebouwd.",
    vergunningenTekst:
      "Een systeemwoning vereist een omgevingsvergunning, maar het vergunningsproces verloopt sneller dankzij de typegoedkeuring. De fabrikant heeft het volledige bouwsysteem vooraf laten testen en goedkeuren, waardoor de gemeente minder hoeft te toetsen. Dit kan weken tot maanden schelen in het vergunningstraject.\n\nDe woning moet passen binnen het bestemmingsplan van de kavel. Systeemwoningen worden doorgaans permanent op een fundering gebouwd en zijn bedoeld als reguliere woning. Ze voldoen aan alle eisen van het Besluit bouwwerken leefomgeving (BBL), inclusief de nieuwste normen voor isolatie, brandveiligheid en geluidsisolatie. Wil je weten wanneer een vergunning nodig is? Raadpleeg onze gids over <a href=\"/kennisbank/mantelzorgwoning-vergunningsvrij\" class=\"text-primary font-medium hover:underline\">vergunningsvrij plaatsen</a>.",
    seniorenTekst:
  ...
  "modulaire-aanbouw": {
    ...
    seniorenTekst:
      "Een modulaire aanbouw is de slimste manier voor senioren om hun woning levensloopbestendig te maken zonder te verhuizen. Cre\u00eber een slaapkamer en badkamer op de begane grond, zodat je de trap niet meer hoeft te gebruiken. Of maak een speciale zorgkamer voor thuiszorg, zodat je langer zelfstandig in je eigen huis kunt blijven wonen. De aanbouw wordt in enkele dagen geplaatst, met minimale overlast. Heb je een aantoonbare zorgbehoefte? Dan kan een <a href=\"/kennisbank/mantelzorgwoning-financieren\" class=\"text-primary font-medium hover:underline\">Blijverslening of Wmo-vergoeding</a> de investering (gedeeltelijk) dekken.",
    seniorenChecklist: [
